...
<main class="bg-white"> 
        <nav class="bg-[#11172b] p-0">
            <section class="lg:px-[10%] px-[2%] flex justify-between items-center ">
                <aside class="flex lg:space-x-4 space-x-2"><img alt="Logo" loading="lazy" width="250" height="200" decoding="async" data-nimg="1" class="cursor-pointer hover:scale-105 transition duration-200 ease-out transform lg:w-[250px] lg:h-[100px] w-[150px] h-[70px] object-contain " style="color:transparent"
                         src="views/WY_logo_light.svg" /></aside>
        ...
        <div class="lg:px-[10%] px-[2%]" >
            <section class="mt-8">
                <div class="flex space-x-8 items-center">
                    <h1 class="text-black lg:text-4xl font-bold">Staff</h1><span class="text-gray-500">All past and present staff of Delta Airlines</span></div>
            </section>
...
<div class='text-center'><img alt='Profile Image' loading='lazy' width='128' height='128' decoding='async' data-nimg='1' class='w-60 h-80 object-cover mx-auto' style='color:transparent' srcSet='next/image?url=%2Fclient.jpeg&amp;w=128&amp;q=75 1x, next/image?url=%2Fclient.jpeg&amp;w=256&amp;q=75 2x'
        src='next/image?url=%2Fclient.jpeg&amp;w=256&amp;q=75' />
    <h1 class='text-3xl font-bold my-4'>Peter Sandro</h1>
</div>
<div class=''>
    <div class='bg-white p-6 rounded-lg shadow-md text-black'>
        ...
        <h2 class='text-xl font-bold mt-8 mb-2'>Work Information:</h2>
        <p>   Job Title:       " . $r_fetch['job'] . " </p>
        <p>   Employee ID:       " .  $r_fetch['EmployeeID']   . "</p>
        <p>   Reporting Manager:        " . $r_fetch['ReportingManager']  . " </p>
        <p>   Work Location:        " . $r_fetch['workLocation']  . " </p>
        <h2 class='text-xl font-bold mt-8 mb-2'>Credentials and Certifications:</h2>
        <p>   Educational Qualifications:        " . $r_fetch['Educational']  . " </p>
        <p>   Certifications:        " . $r_fetch['Certifications']   . "</p>
        <p>   Training Certifications:        " . $r_fetch['TrainingCertifications']   . "</p>
